        ...
        <div class="row content-row">
            <div class="container">
                <div class="row d-flex align-items-center">
                    <div class="col-lg-6">
                        <img class="img-fluid" src="images/img_s2.png" alt="Ilustración elementos">
                    </div>
                    <div class="col-lg-6 mb-4">
                        <div class="row align-items-center justify-content-between mb-3">
                            <div class="col-lg-10 list-of-items">
                                <div class="row item-button align-items-center">
                                    ...
                                    <div class="col-8 item-text">
                                        <p>Diseño Universal para el Aprendizaje (DUA) -Actividades y ajustes razonables-</p>
                                    </div>
                                </div>
                            </div>
                        </div>
