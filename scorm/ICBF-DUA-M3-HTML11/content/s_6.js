            ...
            <div class="container">
                <div class="row d-flex align-items-center">
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <p class="p-box"> <b>Actividad 4: </b> Cuento vivenciado: “¿Qué comemos?”</p>
                    </div>
                    <div class="col-sm-12">
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      <div class="modal-body">
        <h1 class="modal-title">Literatura</h1>
        <div class="row">
          <div class="col">
    ...
    <div class="modal-content">
      <div class="modal-body">
        <div class="mb-4">
            ...
            <p>Reconocer los diferentes animales de la granja</p>
        </div>
        <div class="mb-4">
            <img class="ok-img" src="images/img_s3_ok.png">
            <p>Identificar los alimentos consumidos por diferentes  animales</p>
        </div>
        <div class="mb-4">
            <img class="ok-img" src="images/img_s3_ok.png">
            <p>Estimular los sentidos del gusto, el olfato, la visión y la audición a través de las escenas del cuento</p>
        </div>
        <div >
            <img class="ok-img" src="images/img_s3_ok.png">
            <p>Favorecer la simbolización</p>
        </div>
        <div class="row">
          <div class="col">
            <a href="#" class="btn btn-link btn-next float-right mt-4" data-dismiss="modal"></a>
...
<div class="modal fade master-modal" id="rta-4">
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      <div class="modal-body">
        <p> <b class="content-title mb-4">Materiales:</b> cuento “¿Qué comemos?”, muñecos de peluche (gallo, conejo, perro, gato y un niño) y zanahoria entera y picada. <br>Maíz pepa y maíz pira, un hueso, pescado de peluche o en fomi, ponqué en pedazos y sonidos de animales presentes en el cuento. </p>
        <p> <b class="content-title">Procedimiento:</b> el cuento “¿Qué comemos?” es leído involucrando sentidos como la escucha, la visión y el gusto. A medida que transcurre la lectura del cuento, se va mostrando cada uno de los personajes y también el alimento que come, se familiariza a las niñas y niños con la escena y se les da una degustación del alimento del cual se ha hablado anteriormente.</p>
        <div class="row">
          <div class="col">
            <a href="#" class="btn btn-link btn-next float-right mt-4" data-dismiss="modal"></a>
          </div>
