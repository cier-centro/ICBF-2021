                      ...
                      <div class="col-lg-8 list-of-items">
                        <div class="row item-button align-items-center">
                          ...
                          <div class="col-8 item-text">
                              <p><b>Diversidad en la educación infantil</b></p>
                          </div>
                        </div>
                      </div>
                      <div class="col-lg-4 list-of-items">
                        <p class="p-box">Haga el doble clic sobre el icono para conocer su contenido</p>
                      </div>
                    </div>
                    <div class="col-sm-12">
                      <div class="col-lg-10 offset-lg-1 my-3  mb-5 p-container p-box">
                        <p>Reconozca la diversidad en la primera infancia a partir de las particularidades de las niñas y los niños, sus familias y entornos, con el fin de favorecer que en la educación inicial se promueva el desarrollo integral y los aprendizajes significativos.</p>
                      </div>
                      <div class="text-center col-12">
                          <button class="btn btn-folder">
                            <a href="https://maguared.gov.co/diversidad-en-la-educacion-infantil/" target="_blank" class="btn btn-light btn-pdf float-left"><img class="img-fluid" src="images/img_s7.png" alt="Ilustración elementos"></a>
                          </button>
                      </div>
                      <div class="row mt-5 justify-content-between">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-10 content-center">
                            <button class="d-flex btn row content-center" onclick="currentSlide(12)">
