  ...
  <div class="col">
    ...
    <div class="row content-row align-items-center">
      ...
      <div class="col-sm-10 p-box">
        ...
        <p>¿Cuáles son los objetivos principales del Diseño Universal para el Aprendizaje?</p>         
      </div>
    </div>
...
var slideActivityContent = {
  controller: "",
  corrects: [
    "Eliminar barreras de aprendizaje e incrementar oportunidades de aprendizaje.",    
  ],
  incorrects: [
    "Eliminar barreras de aprendizaje e incrementar la desigualdad del aprendizaje.",
    "Incrementar barreras de aprendizaje y eliminar oportunidades  de aprendizaje.",
    "Incrementar oportunidades de aprendizaje y eliminar alternativas de aprendizaje."    
  ]
};
