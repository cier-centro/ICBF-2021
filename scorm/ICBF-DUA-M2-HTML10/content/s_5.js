            ...
            <div class="col-11 col-lg-10">
                <div class="row align-items-center justify-content-between">
                    <div class="col-lg-4 mt-3 text-center">
                        <img class="img-fluid" src="images/img_ref.png">
                    </div>
                    <div class="col-lg-8">
                        <h1 class="ref-title">Referencias</h1>
                        <p class="f-dent">
                            Vivancos, L. [@lucilogo]. (s. f.).
                            <i>Actividades de grupo.</i> Pinterest.
                            <a href="https://bit.ly/3ljNo6y" target="_blank">https://bit.ly/3ljNo6y</a>
                        </p>
                    </div>
                </div>
            </div>
