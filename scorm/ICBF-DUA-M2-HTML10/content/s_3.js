                    ...
                    <div class="col-lg-8 list-of-items">
                        <div class="row item-button align-items-center">
                            ...
                            <div class="col-8 item-text">
                                ...
                                <p>Pauta 8: Proporcionar opciones para mantener el esfuerzo y la persistencia</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                ...
                                <div id="content1" class="collapse">
                                    <div class="card-body p-3">
                                        <p><b>Ejemplos:</b></p>
                                        <ul>
                                            <li>Diferenciación en el grado de dificultad o complejidad en las actividades básicas que pueden ser realizadas.</li>
                                            <li>Permisividad en el uso de herramientas y apoyos necesarios</li>
