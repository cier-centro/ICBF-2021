    ...
    <div class="row content-row">
      <div class="container">
        <div class="row d-flex align-items-center">
          <div class="col-lg-6">
            <p class="p-box">El artículo 24 de la convención sobre los derechos de las personas con discapacidad dicta lo siguiente:<br><br>
            <i>Todas las personas tienen derecho a ir a la escuela. Si eres discapacitado, no se te puede negar acceso a la educación debido a tu discapacidad. Tampoco se te debería brindar educación en una escuela segregada (que separa o divide a los estudiantes), porque tienes derecho a la misma educación y los mismos programas de estudios que todos los demás niños y niñas. El gobierno de tu país debe darte toda la ayuda necesaria para que eso ocurra. Por ejemplo, debe suministrarte medios de comunicación adecuados para que tus maestros sepan cómo responder a tus necesidades.</i>
            <q>Unicef, 2008,p.14</q>
            </p>
          </div>
          <div class="col-lg-6">
            <div class="row">
              <div class="col-sm-12">
                <p class="question-text p-box">Podemos decir que en el video “los colores de las flores” se cumple con lo dictado en el artículo 24 y es un claro ejemplo de:</p>
              </div>
              <div class="col-sm-12">
                <div class="row answers-buttons">
                  <div class="col-sm-12">
                    <button type="button" class="btn btn-light square-left" data-toggle="modal" data-target="#rta-incorrect-1">
                      ...
                      <p class="answer-text">Integración social</p>
                    </button>
                  </div>
                  <div class="col-sm-12">
                    <button type="button" class="btn btn-light square-left" data-toggle="modal" data-target="#rta-incorrect-1">
                      ...
                      <p class="answer-text">Discriminación en la educación</p>
                    </button>
                  </div>
                  <div class="col-sm-12">
                    <button type="button" class="btn btn-light square-left" data-toggle="modal" data-target="#rta-correct-1">
                      ...
                      <p class="answer-text"><i>Educación inclusiva</i></p>
                    </button>
                  </div>
                </div>
              </div>
