    ...
    <div class="row content-row">
      <div class="container">
        <div class="row d-flex align-items-center">
          <div class="col-lg-6 lateral-title text-center">
            <h2 class="tx-green-dark">Múltiples opciones</h2>
            <h2 class="tx-orange-orange">de los principios DUA</h2>
          </div>
          <div class="col-lg-6">
            
            <div class="row list-of-items">

              <button class="col-sm-12 d-flex item-button" onclick="currentSlide(5)">
                <div class="row">
              ...
              <button class="col-sm-12 d-flex item-button" onclick="currentSlide(6)">
                <div class="row">
                  <div class="icon-holder col-4">
                    <img class="img-fluid" src="images/img_s4_opc2.png" alt="Ilustración elementos">
                  </div>
                  <div class="col-7 item-text medium-font-size d-flex">
                    <p>El diseño Curricular</p>
                  </div>
              ...
              <button class="col-sm-12 d-flex item-button" onclick="currentSlide(7)">
                <div class="row">
                  <div class="icon-holder col-4">
