  ...
  <div class="col">
    ...
    <div class="row content-row align-items-center">
      ...
      <div class="col-sm-10 p-box">
        ...
        <p>Carlitos es un estudiante que en el momento del descanso no juega con sus compañeros y se disgusta mucho, dado que cuando están corriendo es el único de sus amigos que se cae y se tropieza con frecuencia en el patio de juego. Sería bueno aconsejarle a la docente de Carlitos que lo ayude a desarrollar la inteligencia…</p>         
      </div>
    </div>
    <div class="row align-items-center">
      <div class="col-lg-1 hidden-sm text-center"></div>
      <div class="col-lg-4 col-sm-12 text-center">
        <img class="img-fluid" src="images/img_s4_content.png" alt="Pregunta 4">
      </div>      
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-body">
        ...
        <p>Se debe ayudar a desarrollar la inteligencia cinético-corporal  para que, con el tiempo, Carlitos se pueda desenvolver mejor en el patio de juego. Además es posible identificar en qué otras inteligencias es fuerte para poder, desde esas capacidades, apoyar la inteligencia cinético-corporal.</p>        
      </div>
    </div>
  </div>
</div>
...
var slideActivityContent = {
  controller: "",
  corrects: [
    "cinético-corporal con ayuda de sus pares y algunos apoyos graduales para desenvolverse mejor en el patio de juego.",    
  ],
  incorrects: [
    "interpersonal que le permita convivir sin enojarse con otros compañeros.",
    "ecológica que le permitirá interactuar mejor con el mundo natural que le rodea.",
    "Visual-espacial para que pueda desenvolverse mejor en su entorno."    
  ]
};
