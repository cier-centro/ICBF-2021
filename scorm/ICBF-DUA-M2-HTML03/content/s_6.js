  ...
  <div class="col">
    ...
    <div class="row content-row align-items-center">
      ...
      <div class="col-sm-10 p-box">
        ...
        <p>Plantear actividades en que los estudiantes realicen actividades en grupo, roten el rol de coordinador (a), asuman diversas posiciones y preparen en grupo un debate acerca de temas específicos, son actividades que están favoreciendo el desarrollo de la inteligencia…</p>         
      </div>
    </div>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-body">
        ...
        <p>El desarrollo de la inteligencia interpersonal se favorece cuando se permite que el estudiante reconozca a sus compañeros desde sus debilidades y fortalezas y pueda usar esa información para favorecer el logro de una meta compartida.</p>        
      </div>
    </div>
  </div>
</div>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-body">
        ...
        <p>Revise en qué consiste cada una de las inteligencias presentadas y algunas actividades que puedan plantearse para su desarrollo e intente resolver la actividad nuevamente.</p>        
      </div>
    </div>
  </div>
</div>
