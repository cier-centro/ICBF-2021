            ...
            <div class="container">
                <div class="row d-flex responsive-container">
                        ...
                        <div class=" col-12 ">
                            <div class="list-of-items ">
                              <div class="row item-button align-items-center">
                                  ...
                                  <div class="col-8 item-text">
                                      <p>¿Qué espero que pase en la vida de las niñas, los niños, las mujeres gestantes, sus familias y comunidades?</p>
                                  </div>
                              </div>
                            </div>
                            <div class="list-of-items mt-5">
                              <div class="row item-button align-items-center">
                                  ...
                                  <div class="col-8 item-text">
                                      <p>¿Qué hace particular mi proceso de atención?</p>
                                  </div>
                              </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-10 s4-container">
                      <img class="img-fluid" src="images/img_s8.png" alt="Ilustración elementos">
                    </div>
                </div>
            </div>
        </div>
